//QuoteAdd4Action.java collects the source info
//for this quote
...
public final class QuoteAdd4Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //need the quote to add this source
        ...
        Integer sdId = QuoteService.getInstance().addSourceWithQuote(q, sd);            
        
        //place sourceDoc into cookie; this will be used later in wizard when adding targetDocs
        response.addCookie(StandardCode.getInstance().setCookie("quoteAddSourceDocId", String.valueOf(sdId)));
        //save in cookie for future target adding
        response.addCookie(StandardCode.getInstance().setCookie("quoteAddLanguage", sourceLanguage));

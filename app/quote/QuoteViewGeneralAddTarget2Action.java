//QuoteViewGeneralAddTarget2Action.java collects the target(s) info
//for one or more sources within one quote
...
public final class QuoteViewGeneralAddTarget2Action extends Action {
	...
	quoteId = request.getParameter("quoteViewId");
        ...
        SourceDoc[] sources = (SourceDoc[]) session.getAttribute("quoteViewGeneralAddTargetSources");        

//QuoteAdd2Action.java collects values related to 
//the contact for this quote from this part of the wizard
//It then adds this info to the project
//that this quote is related to
...
public final class QuoteAdd2Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //need the project, quote, and contact to build the link between contact and project

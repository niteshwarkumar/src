//QuoteViewGeneralAddTarget1Action.java gets the sources
...
public final class QuoteViewGeneralAddTarget1Action extends Action {
	...
	HttpSession session = request.getSession(false);
        session.setAttribute("quoteViewGeneralAddTargetSources", sources);

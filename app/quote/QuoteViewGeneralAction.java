//QuoteViewGeneralAction.java gets the current Quote1 from the db
//It then places that quote into the quoteViewGeneral form for
...
public final class QuoteViewGeneralAction extends Action {
...
try{
      ...
      //  Collections.sort(totalOthTasks, CompareTaskOth.getInstance());
        ...
        Collections.sort(totalOthTasks, CompareTaskLanguages.getInstance());

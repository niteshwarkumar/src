//QuoteViewGeneralAddTaskEng1Action.java gets the sources
...
public final class QuoteViewGeneralAddTaskEng1Action extends Action {
	...
	quoteId = request.getParameter("quoteViewId");
        ...
        String[] sourceIds = (String[]) qvgate1.get("sourceIds");

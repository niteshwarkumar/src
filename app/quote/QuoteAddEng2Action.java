//QuoteAddEng2Action.java gets the added tasks
...
public final class QuoteAddEng2Action extends Action {
        ...
        if(!all.equals("on")) { //if specific to only a few targets
            ...
            for(int i = 0; i < targets.length; i++) {          
                ...
                if(eng2.equals("on")) { //if checked in form, then add this task to target Doc
                    ...
                    if(clp != null){  
                         for(int z=0; z<clp.length; z++){                       
                            if(clp[z].getSource()!=null && clp[z].getSource().equals(et.getSourceLanguage()) && clp[z].getTarget()!=null && clp[z].getTarget().equals(et.getTargetLanguage()) && clp[z].getTask()!=null && clp[z].getTask().equals("ENG - "+et.getTaskName())){                            
                                et.setRate(clp[z].getRate());
                                et.setUnits(clp[z].getUnits());
                                break;
                            }

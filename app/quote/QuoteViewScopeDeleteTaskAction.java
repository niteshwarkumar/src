 ...
 * @author Niteshwar
 */
public class QuoteViewScopeDeleteTaskAction  extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        Quote1 q = QuoteService.getInstance().getSingleQuote(Integer.parseInt(id));
        String task="";

        //delete tasks

        for (Iterator iter1 = q.getSourceDocs().iterator(); iter1.hasNext();) {

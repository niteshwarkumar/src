//QuoteViewGeneralGenerateMedicalAction.java creates the
//Medical Quote pdf
package app.quote;
...
public final class QuoteViewGeneralGenerateMedicalAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        byte[] template = getBytesFromFile(new java.io.File("C:/templates2/template_medical.rtf"));
...
//            String[] fname = q.getProject().getPm().split(" ");
        ...
        response.setHeader("Content-disposition", "attachment; filename=" + q.getNumber() + "-" + q.getProject().getCompany().getCompany_name().replaceAll(" ", "_").replaceAll(",", "_") + "_quote.doc");

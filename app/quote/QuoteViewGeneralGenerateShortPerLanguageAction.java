 ...
 * @author Niteshwar
 */
public final class QuoteViewGeneralGenerateShortPerLanguageAction extends Action {
...
"\\\\clcbpat17\\\\cltxlrtb\\\\clftsWidth3\\\\clwWidth2164\\\\clcbpatraw17\\\\clhidemark \\\\cellx10084\\\\row }";
        ...
        byte[] template = getBytesFromFile(new java.io.File("C:/templates2/T5.002 - Quote template - short_non_medical_per_language.rtf"));
...
content = content.replaceAll("REPLACE_MORE_LANGUAGE_TABLE", "");
        ...
        try {
            ...
            content = content.replaceAll("INSERT_CURRENCY_INSERT", StandardCode.getInstance().noNull(curr));
             ...
             content = content.replaceAll("INSERT_CURRENCY_INSERT", "");
      ...
      if(!linTasksArray[i].getTaskName().equalsIgnoreCase("ICR")&&!linTasksArray[i].getTaskName().equalsIgnoreCase("ICR ")&&!linTasksArray[i].getTaskName().equalsIgnoreCase("In-Country Review (ICR)")&&!linTasksArray[i].getTaskName().equalsIgnoreCase("In-Country / Client Review")){
        ...
        try {
            ...
            content = content.replaceAll("INSERT_ALL_TOTALPRICE_INSERT", StandardCode.getInstance().noNull(curr));
...
try{
            ...
            content = content.replaceAll("INSERT_EMAIL_PM_INSERT", "");
            content = content.replaceAll("INSERT_PHONE_EXTENSION_PM_INSERT", "");

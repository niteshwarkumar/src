//QuoteViewGeneralAddTaskEngPreAction.java gets all of the sources
...
public final class QuoteViewGeneralAddTaskEngPreAction extends Action {
	...
	qvgate1.set("sources", (SourceDoc[]) sources.toArray(new SourceDoc[0]));

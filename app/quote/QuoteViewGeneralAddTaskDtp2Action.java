//QuoteViewGeneralAddTaskDtp2Action.java gets the added tasks
...
public final class QuoteViewGeneralAddTaskDtp2Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        String[] dtpTaskOptions = QuoteService.getInstance().getDtpTaskOptions();

...
import app.project.ProjectScopeEditUpdateAction;
 ...
 * @author abc
 */
public class QuoteViewFormsAction  extends Action {
	...
	quoteId = request.getParameter("quoteViewId");
        ...
        response.addCookie(StandardCode.getInstance().setCookie("quoteViewTab", "Forms"));

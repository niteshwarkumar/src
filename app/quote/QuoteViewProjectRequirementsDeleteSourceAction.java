//QuoteViewProjectRequirementsDeleteSourceAction.java deletes one source
//and its targets and tasks
...
public final class QuoteViewProjectRequirementsDeleteSourceAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //delete source, targets, tasks
        SourceDoc sd = ProjectService.getInstance().getSingleSourceDoc(Integer.valueOf(id));
        ...
        AdminService.getInstance().delete(sd);        

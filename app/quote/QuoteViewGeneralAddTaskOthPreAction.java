//QuoteViewGeneralAddTaskOthPreAction.java gets all of the sources
...
public final class QuoteViewGeneralAddTaskOthPreAction extends Action {
	...
	qvgato1.set("sources", (SourceDoc[]) sources.toArray(new SourceDoc[0]));

//QuoteViewFileListAdd1Action.java adds the new
//file to the db and builds the one-to-many
...
public final class QuoteViewFileListAdd1Action extends Action {
	...
	quoteId = request.getParameter("quoteViewId");
        ...
        //get new file from form
        DynaValidatorForm qvf = (DynaValidatorForm) form;
        File f = (File) qvf.get("quoteFile");
        
        //add file to db and build one-to-many relationship between quote and file (quote file)   

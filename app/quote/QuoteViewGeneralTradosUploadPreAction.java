//QuoteViewGeneralTradosUploadPreAction.java gets the display
...
public final class QuoteViewGeneralTradosUploadPreAction extends Action {
	...
	quoteId = request.getParameter("quoteViewId");
        ...
        response.addCookie(StandardCode.getInstance().setCookie("quoteViewGeneralTradosUploadId", request.getParameter("id")));

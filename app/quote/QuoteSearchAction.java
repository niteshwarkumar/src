//QuoteSearchAction.java collects the search criteria from the form
//and performs the search on quotes
...
public final class QuoteSearchAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        String status = (String) qs.get("status");
    ...
    //   }catch(Exception e){}
      ...
      //  //System.out.println("Result size of Quote >>>>>>>>>>>>>>>"+results.size());
        ...
        request.getSession(false).setAttribute("sortedQuoteResults", finalResults) ;

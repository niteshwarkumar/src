//QuoteViewGeneralAddSourcePreAction.java gets the display
//ready (the heading) for adding new sources
...
public final class QuoteViewGeneralAddSourcePreAction extends Action {

...
public final class QuoteViewGeneralGenerateBsdAction extends Action {
	...
	quoteId = request.getParameter("quoteViewId");
        ...
        byte[] template = getBytesFromFile(new java.io.File("C:/templates2/template_short_proposal_bsd.rtf"));

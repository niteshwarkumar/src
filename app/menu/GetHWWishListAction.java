 ...
 * @author Niteshwar
 */
public class GetHWWishListAction extends Action{
...
List HW=MenuService.getInstance().getHWWishList();

            //System.out.println("                  working                     ");
            //String ty="lk";

for(int i=0;i<HW.size();i++){
    Hardware h=(Hardware)HW.get(i);
            JSONObject jo = new JSONObject();
            jo.put("Equipment",h.getEquipment());
            jo.put("Description",h.getDescription());
            jo.put("Detail",h.getDetail());
            jo.put("Make",h.getMake());
            jo.put("Model",h.getModel());

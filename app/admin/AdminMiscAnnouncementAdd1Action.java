//AdminMiscCurrencyAdd1Action.java adds the new currency
...
public final class AdminMiscAnnouncementAdd1Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Currency1 currencyNew = (Currency1) amg.get("currencyNew");
        
        //add to db
        ProjectService.getInstance().addCurrency(currencyNew);

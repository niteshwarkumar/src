//AdminMiscGeneralAdd1Action.java adds the new general industry
...
public final class AdminMiscGeneralAdd1Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //get new general industry
        DynaValidatorForm amg = (DynaValidatorForm) form;
        Industry generalNew = (Industry) amg.get("generalNew");
        
        //add to db
        ClientService.getInstance().addIndustry(generalNew);

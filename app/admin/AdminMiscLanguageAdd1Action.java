//AdminMiscLanguageAdd1Action.java adds the new language
...
public final class AdminMiscLanguageAdd1Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Language languageNew = (Language) amg.get("languageNew");
        
        //add to db
        ProjectService.getInstance().addLanguage(languageNew);

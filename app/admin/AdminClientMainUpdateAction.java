//AdminClientMainUpdateAction.java gets client-module related options
...
public final class AdminClientMainUpdateAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        for(int i = 0; i < usersArray.length; i++) {
            ...
            String clientViewAccountTab = request.getParameter("clientViewAccountTab" + String.valueOf(i));
            String clientUpdateAccountTab = request.getParameter("clientUpdateAccountTab" + String.valueOf(i));
            
            //update each privilege per user
            if(clientViewAccountTab != null) {
                if(!StandardCode.getInstance().checkPrivSet(usersArray[i].getPrivileges(), "clientViewAccountTab")) {
                    Privilege p = new Privilege();
                    p.setPrivilege("clientViewAccountTab");
            ...
            if(clientUpdateAccountTab != null) {
                ...
                for(Iterator iter = usersArray[i].getPrivileges().iterator(); iter.hasNext();) {
                    Privilege p = (Privilege) iter.next();
                    if(p.getPrivilege().equals("clientUpdateAccountTab")) {
                        UserService.getInstance().deletePrivilege(p);
                    }
                }
            }

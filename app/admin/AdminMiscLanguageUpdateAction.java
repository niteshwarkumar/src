//AdminMiscLanguageUpdateAction.java updates a list
//of languages
...
public final class AdminMiscLanguageUpdateAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Language[] languages = (Language[])  amg.get("languages");
                
        //update the languages
        for(int i = 0; i < languages.length; i++) {
            ProjectService.getInstance().updateLanguage(languages[i]);
        }

 ...
 * @author Niteshwar
 */
public class AdminMiscTickerSettingAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //get languages
        List location = UserService.getInstance().getLocationList();

        //place languages into form
        DynaValidatorForm amg = (DynaValidatorForm) form;
        Location[] locationArray = (Location[]) location.toArray(new Location[0]);
        amg.set("location", locationArray);

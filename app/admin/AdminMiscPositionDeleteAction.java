 ...
 * @author Niteshwar
 */
public class AdminMiscPositionDeleteAction  extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Position1 l = UserService.getInstance().getSinglePositionById(Integer.valueOf(posId));
        try {
           UserService.getInstance().deletePosition(l);
        } catch (Exception e) {
        }
        //delete the language

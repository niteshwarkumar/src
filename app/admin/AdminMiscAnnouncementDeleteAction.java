//AdminMiscAnnouncementDeleteAction.java deletes one announcement
...
public final class AdminMiscAnnouncementDeleteAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Announcement a = MenuService.getInstance().getSingleAnnouncement(Integer.valueOf(announcementId));        
        
        //delete the announcement
        MenuService.getInstance().deleteAnnouncement(a);

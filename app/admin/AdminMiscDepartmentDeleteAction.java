//AdminMiscCurrencyDeleteAction.java deletes one currency
...
public final class AdminMiscDepartmentDeleteAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Department c = UserService.getInstance().getSingleDepartment(Integer.valueOf(departmentId));        
        
        //delete the currency
        //ProjectService.getInstance().deleteCurrency(c);
        UserService.getInstance().deleteDepartment(c);

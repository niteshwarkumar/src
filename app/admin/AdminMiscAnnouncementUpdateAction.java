...
public final class AdminMiscAnnouncementUpdateAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Currency1[] currencies = (Currency1[])  amg.get("currencies");
                
        //update the currencies
        for(int i = 0; i < currencies.length; i++) {
            ProjectService.getInstance().updateCurrency1(currencies[i]);
        }

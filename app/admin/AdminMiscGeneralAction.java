//AdminMiscGeneralAction.java gets the general
...
public final class AdminMiscGeneralAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        List generals = ClientService.getInstance().getIndustryList();
                
        //place general industries into form
        DynaValidatorForm amg = (DynaValidatorForm) form;
        Industry[] generalsArray = (Industry[]) generals.toArray(new Industry[0]);
        amg.set("generals", generalsArray);          

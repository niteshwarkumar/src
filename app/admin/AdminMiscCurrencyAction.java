...
public final class AdminMiscCurrencyAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //get currencies
        List currencies = ProjectService.getInstance().getCurrencyList();
                
        //place currencies into form
        DynaValidatorForm amg = (DynaValidatorForm) form;
        Currency1[] curriencesArray = (Currency1[]) currencies.toArray(new Currency1[0]);
        amg.set("currencies", curriencesArray);          

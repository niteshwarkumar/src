//AdminMiscGeneralUpdateAction.java updates a list
...
public final class AdminMiscGeneralUpdateAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Industry[] generals = (Industry[])  amg.get("generals");
                
        //update the general industries
        for(int i = 0; i < generals.length; i++) {
            ClientService.getInstance().updateIndustry(generals[i]);
        }

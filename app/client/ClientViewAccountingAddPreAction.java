//ClientViewAccountingAddPreAction.java prepares the form
//for adding a new client language pair object
...
public final class ClientViewAccountingAddPreAction extends Action {
	...
	clientId = request.getParameter("clientViewId");
        ...
        ClientLanguagePair clp = new ClientLanguagePair();
       qvg.set("clientLanguagePairNew", clp);    

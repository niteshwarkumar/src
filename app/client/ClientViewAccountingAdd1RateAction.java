//ClientViewAccountingAdd1RateAction.java adds the new
//client other rate object to the db and builds
//the one-to-many relationship between client and client other rate
...
public final class ClientViewAccountingAdd1RateAction extends Action {
	...
	clientId = request.getParameter("clientViewId");
        ...
        ClientOtherRate cor = (ClientOtherRate) qvg.get("clientOtherRateNew");
        
        //add this client other rate to db and bind it to this client
        ClientService.getInstance().addCorWithClient(cor, c);

//ClientContactAddWizardAction.java collects the new contact info
...
public final class ClientContactAddWizardAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        String clientId = StandardCode.getInstance().getCookie("quoteAddClientId", request.getCookies());
        ...
        //place contact into request for use in wizard
        request.setAttribute("clientContactViewId", String.valueOf(cc.getClientContactId()));        

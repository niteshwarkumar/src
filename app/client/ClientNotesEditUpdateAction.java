//ClientNotesEditUpdateAction.java gets the new note value
//from a form (related to client) and uploads it to the db
...
public final class ClientNotesEditUpdateAction extends Action {

...
public final class ClientUpdateServicesAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        ClientService.getInstance().updateClientServices(Integer.parseInt(id),request.getParameter("serviceJSON"));

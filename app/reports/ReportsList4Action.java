//ReportsList4Action.java gets the display
...
public final class ReportsList4Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //run report search
        List results = ReportsService.getInstance().runReport4(pm, dateB, dateC);
        ...
        session.setAttribute("title", "All Projects by Project Manager " + pm + " from " + DateFormat.getDateInstance(DateFormat.SHORT).format(dateB) + " to " + DateFormat.getDateInstance(DateFormat.SHORT).format(dateC) + resultsSize);

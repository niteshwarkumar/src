//HrAdminEmployeeMaintenanceViewUnpaidPreAction.java sets up the display
...
public final class HrAdminEmployeeMaintenanceViewUnpaidPreAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //get away events
        List aways = UserService.getInstance().getUserUnpaidHistoryYear(u.getUserId(), u.getHireDate());

//HrAdminRemoveEmployeePreAction.java gets all users (current employees)
//from the db and places them into a form for display
//so user can choose one to delete (actually
//just marked as currentEmployee=false)
...
public final class HrAdminRemoveEmployeePreAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        List results = UserService.getInstance().getUserListCurrent();
         ...
         List resultsClient = UserService.getInstance().getUserList();
                
        //place final results in attribute for displaying in jsp
        request.setAttribute("results", results);
         request.setAttribute("resultsClient", resultsClient);

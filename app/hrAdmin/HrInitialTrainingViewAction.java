 ...
 * @author Niteshwar
 */
public class HrInitialTrainingViewAction extends Action {
...
//                }
        ...
        try {
            ...
            PreparedStatement pstmt = session.connection().prepareStatement("select * from traininginitial where ID_User=" + id);
            ...
            while (rs.next()) {
                ...
                if (rs.getDate("traindate") != null) {
                    if (rs.getString("trainer").equalsIgnoreCase("")) {
                        jo.put("completed", "completed");
                    } else {
                        jo.put("completed", StandardCode.getInstance().noNull(rs.getString("trainer")));
                    }

 ...
 * @author Neil
 */
public class HrTrainingViewAction extends Action {
	 ...
	 Session session = ConnectionFactory.getInstance().getSession();
      ...
      String jsonProducts = request.getParameter("blogJSON");
        ...
        try {
         ...
         PreparedStatement pstmt = session.connection().prepareStatement("select * from training where ID_User="+id);
         ...
         // ClientService.getInstance().getBlogList();
           ...
           while(rs.next())
            ...
            jo.put("id", rs.getInt("ID_Training"));
            jo.put("description", rs.getString("description"));
            jo.put("company", rs.getString("company"));
//            jo.put("trainer", rs.getString("trainer"));
            jo.put("location", rs.getString("location"));
            jo.put("from", rs.getDate("dateStart"));
            jo.put("to", rs.getDate("dateCompleted"));
            jo.put("result", rs.getString("result"));
            jo.put("evidence", rs.getString("evidence"));

            jo.put("effectiveness", rs.getString("effectiveness"));
            jo.put("verifiedBy", rs.getString("verifiedBy"));
            jo.put("verificationResult", rs.getString("verificationResult"));

//HrAdminEmployeeMaintenanceViewVacationPreAction.java sets up the display
...
public final class HrAdminEmployeeMaintenanceViewVacationPreAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //get away events
        List aways = UserService.getInstance().getUserVacationHistoryYear(u.getUserId(), u.getHireDate());

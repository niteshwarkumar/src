//HrAdminEmployeeMaintenanceViewTravelPreAction.java sets up the display
...
public final class HrAdminEmployeeMaintenanceViewTravelPreAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        //get away events
        List aways = UserService.getInstance().getUserTravelHistoryYear(u.getUserId(), u.getHireDate());

//ResourceViewProjectsAction.java gets the current team object (resource)
//from the db.  It then places that resource into the 
//form featuring a history of projects worked on
...
public final class ResourceViewProjectsAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        response.addCookie(StandardCode.getInstance().setCookie("resourceViewTab", "Projects"));

...
public final class ResourceViewContactSingleUpdateAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        ResourceContact rc = (ResourceContact) rvt.get("resourceContactFromForm");
        
        ResourceService.getInstance().updateResourceContact(rc);      

//ResourceViewSpecialtiesAddSpecific1Action.java gets the
//general category from the db so the user can select
//more specific categories (specialties)
...
public final class ResourceViewSpecialtiesAddSpecific1Action extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        //values for getting general category from form
        DynaValidatorForm rvs = (DynaValidatorForm) form;
       
        String[] generalIds = (String[]) rvs.get("generalId");
        
        String generalId = generalIds[0];
       
        //get the general (industry) from db

//ResourceViewContactAddPreAction.java gets the current team object (resource)
//from the db.  It then places that resource into the 
//form for display. It creates a new ResouceContact for adding to db
...
public final class ResourceViewContactAddPreAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        rvac.set("resourceContactAdd", new ResourceContact());

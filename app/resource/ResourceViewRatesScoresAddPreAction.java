//ResourceViewRatesScoresAddPreAction.java gets the current team object (resource)
//from the db.  It then places that resource into the 
//form for display; the display will need the languagePair collection
...
public final class ResourceViewRatesScoresAddPreAction extends Action {

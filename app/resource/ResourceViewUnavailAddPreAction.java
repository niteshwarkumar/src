//ResourceViewUnavailAddPreAction.java gets the 
//form ready for adding unavails
...
public final class ResourceViewUnavailAddPreAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        rvt.set("unavailNew", new Unavail());

//ResourceViewLanguagesAction.java gets the current team object (resource)
//from the db.  It then places that resource into the 
//form featuring language pairs
...
public final class ResourceViewLanguagesAction extends Action {

public ResourceViewLanguagesAction()
{
    System.out.println("ResourceViewLanguagesAction constructor is calling****************");
}

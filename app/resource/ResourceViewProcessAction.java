//ResourceViewResumeAction.java gets the current team object (resource)
//from the db.  It then places that resource into the resource form for
//display in the jsp page featuring resume.
//The resume is saved in text format in the db.
//It then places location values into cookies
...
public final class ResourceViewProcessAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        response.addCookie(StandardCode.getInstance().setCookie("resourceViewTab", "Resume"));

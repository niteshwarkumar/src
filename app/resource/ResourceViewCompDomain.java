 ...
 * @author niteshwar
 */
public class ResourceViewCompDomain extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        List<ResourceCompDomain> resCompDomain = new ArrayList<>();
        JSONObject resCompDomainObj = new JSONObject();
        

//prepare the language pairs for display
        ...
        List<ResourceCompDomain> resCompDomainForLangPair = ResourceService.getInstance().getCompetanceDomain(lp.getLanguagePairId());
        if(resCompDomainForLangPair!=null)    
//            for(ResourceCompDomain rcd : resCompDomainForLangPair){
//                JSONObject 
//            }
            resCompDomain.addAll(resCompDomainForLangPair);
        }
        //load resource info for editing
//        DynaValidatorForm rvl = (DynaValidatorForm) form;
//        rvl.set("languagePairs", languagePairsArray);
        request.setAttribute("languagePairs", languagePairsArray);
        request.setAttribute("resCompDomain", resCompDomain);
        ...
        response.addCookie(StandardCode.getInstance().setCookie("resourceViewTab", "Languages"));

//ResourceViewFormsAction.java gets the current team object (resource)
//from the db.  It then places that resource into the resource form for
//display in the jsp page featuring forms. It then places location values into
//cookies
...
public final class ResourceViewFormsAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
       ...
       // rvt.set("resourceFromForm", r);
        ...
        response.addCookie(StandardCode.getInstance().setCookie("resourceViewTab", "Forms"));

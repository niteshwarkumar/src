//ResourceViewRatesScoresDtpAdd2Action.java gets the 
//new rate-score-dtp from the form
//and uploads this to the db for this resource
...
public final class ResourceViewRatesScoresDtpAdd2Action extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        RateScoreDtp rateScoreDtpAdd = (RateScoreDtp) rvrs.get("rateScoreDtpAdd");
        
        //build link (one-to-many) between resource and rateScoreDtp
        ResourceService.getInstance().linkResourceRateScoreDtp(r, rateScoreDtpAdd);                    

//ResourceAddEditFreelanceAction.java gets new team info
//from a form.  It then adds the new values for
//this resource (freelance) to the db
...
public final class ResourceAddEditFreelanceAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        if(request.getParameter("resourceNew.doNotUse") != null) {
            r.setDoNotUse(true);
        }
        else {
            r.setDoNotUse(false);

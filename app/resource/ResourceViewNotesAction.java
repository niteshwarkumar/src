//ResourceViewNotesAction.java gets the current team object (resource)
//from the db.  It then places that resource into the resource form for
//display in the jsp page featuring notes. It then places location values into
//cookies
...
public final class ResourceViewNotesAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        response.addCookie(StandardCode.getInstance().setCookie("resourceViewTab", "Notes"));

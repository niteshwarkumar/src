//ResourceViewSpecialtiesAddGeneral1Action.java gets the 
//new general category to link to this resource
...
public final class ResourceViewSpecialtiesAddGeneral1Action extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        Industry i = ClientService.getInstance().getSingleIndustry(Integer.valueOf(generalId[j]));
             
        //build the many-to-many link between resource and industry
        ResourceService.getInstance().linkResourceIndustry(r, i);

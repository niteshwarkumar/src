//ResourceViewContactSingleAction.java gets the current team object (resource)
//from the db.  It then places that resource into the 
//form for display. It also gets the resourceContact to display/edit
...
public final class ResourceViewContactSingleAction extends Action {
	...
	resourceId = request.getParameter("resourceViewId");
        ...
        String resourceViewContact = request.getParameter("resourceContactId");
        ResourceContact rc = ResourceService.getInstance().getSingleResourceContact(Integer.valueOf(resourceViewContact));
        
        
        rvt.set("resourceContactFromForm", rc);
        
        request.setAttribute("resource", r);        
        request.setAttribute("resourceContact", rc); 

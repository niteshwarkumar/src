//ProjectViewFormsGen10Action.java creates the
//RFQ for ICR pdf
...
public final class ProjectViewFormsGen10Action extends Action {
...
//        Resource r = ResourceService.getInstance().getSingleResource(Integer.valueOf(lt.getPersonName()));
            ...
            //START process pdf
            try {
                PdfReader reader = new PdfReader("C:/templates/LI08_001.pdf"); //the template
...
//                }
                ...
                response.setHeader("Content-disposition", "attachment; filename=" + "RFQ-for-ICR" + ".pdf");

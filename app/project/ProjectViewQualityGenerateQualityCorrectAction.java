//ProjectViewQualityGenerateQualityCorrectAction.java creates the
//report (PDF) that tells how to correct/prevent the quality
//control issue for this project
...
public final class ProjectViewQualityGenerateQualityCorrectAction extends Action {
	...
	projectId = request.getParameter("projectViewId");
        ...
        if(qualityId != null) { //generate quality report
            ...
            //START process pdf
            try {
                PdfReader reader = new PdfReader("C:/templates/ISO01_002.pdf"); //the template
                ...
                form1.setField("ncr1", p.getNumber() + p.getCompany().getCompany_code() + "-NC-" + q.getNumber());
...
//                //END add images
                ...
                response.setHeader("Content-disposition", "attachment; filename=" + p.getNumber() + p.getCompany().getCompany_code() + "-NC-" + q.getNumber() + "-Correct-Prevent" + ".pdf");
                OutputStream os;

//ProjectViewFormsGen3Action.java creates the
//Proofreader Checklist pdf
...
public final class ProjectViewFormsGen3Action extends Action {
        ...
        try{
           ...
           flag=0;}  //START process pdf
            ...
            try {
                ...
                PdfReader reader = new PdfReader("C:/templates/LI03_001.pdf"); //the template
...
//                //END add images
                ...
                response.setHeader("Content-disposition", "attachment; filename=" + p.getNumber() + p.getCompany().getCompany_code() +/* "-PO-" + lt.getPoNumber() +*/ "-ProofreaderChecklist" + ".pdf");

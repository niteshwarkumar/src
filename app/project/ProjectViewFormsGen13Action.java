...
public final class ProjectViewFormsGen13Action extends Action {
	...
	projectId = request.getParameter("projectViewId");
        ...
        if(request.getParameter("fromTeam") != null) {
            r = ResourceService.getInstance().getSingleResource(Integer.valueOf(dtpId));
        }
        else {
            DtpTask dt = ProjectService.getInstance().getSingleDtpTask(Integer.valueOf(dtpId));
            try{
            ...
            //START process pdf
            try {
                PdfReader reader = new PdfReader("C:/templates/DTP-PO.pdf"); //the template

//ProjectViewTeamAddSource2Action.java adds new
...
public final class ProjectViewTeamAddSource2Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
       ...
       //values for adding a new target Doc
        ...
        String sourceDocId = StandardCode.getInstance().getCookie("projectViewGeneralAddSourceId", request.getCookies());

//ProjectViewFormsGen2Action.java creates the
//Editor Checklist pdf
...
public final class ProjectViewFormsGen2Action extends Action {
	...
	projectId = request.getParameter("projectViewId");
        ...
        r = ResourceService.getInstance().getSingleResource(Integer.valueOf(lt.getPersonName()));
            ...
            //START process pdf
            try {
                PdfReader reader = new PdfReader("C:/templates/LI02_001.pdf"); //the template
...
//                //END add images
                ...
                response.setHeader("Content-disposition", "attachment; filename=" + p.getNumber() + p.getCompany().getCompany_code() +  "-EditorChecklist" + ".pdf");

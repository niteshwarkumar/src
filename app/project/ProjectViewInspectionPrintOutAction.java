//ProjectViewInspectionPrintOutAction.java displays inspection info
//for a project in a printout table
...
public final class ProjectViewInspectionPrintOutAction extends Action {
	...
	projectId = request.getParameter("projectViewId");
        ...
        //get inspections that apply to this project
        ArrayList inspections = new ArrayList();
        for(Iterator iter = p.getInspections().iterator(); iter.hasNext();) {
            Inspection i = (Inspection) iter.next();
            if(i.isApplicable()) {
                inspections.add(i);
            }
        }
        ...
        //place inspections and targets into request for display

 ...
 * @author niteshwar
 */
public class ProjectViewFormsGen18Action  extends Action {
...
//                PdfReader reader = new PdfReader("C:/templates/PM01_001.pdf"); //the template
                PdfReader reader = new PdfReader("C:/templates/PaymentOption_04Apr2017.pdf"); //the template
...
//                //END add images
                ...
                if(r!=null){
                if((r.getFirstName() != null) && (r.getLastName() != null) && !(r.getFirstName().equalsIgnoreCase(""))) {
                    response.setHeader("Content-disposition", "attachment; filename=" + StandardCode.getInstance().noNull(r.getFirstName()) + "_" + StandardCode.getInstance().noNull(r.getLastName()) + "-payment-options" + ".pdf");
                }
                else {
                    response.setHeader("Content-disposition", "attachment; filename=" + StandardCode.getInstance().noNull(r.getCompanyName()).replaceAll(" ", "_").replaceAll(",", "_") + "-payment-options" + ".pdf");
                }}else{
                                 response.setHeader("Content-disposition", "attachment; filename=Payment Options" + ".pdf");

//ProjectViewTeamAddTarget1Action.java gets the sources
...
public final class ProjectViewTeamAddTarget1Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        String[] sourceIds = (String[]) qvgatl1.get("sourceIds");
        ...
        //save the sources in session for use when adding targets
	HttpSession session = request.getSession(false);
        session.setAttribute("projectViewGeneralAddTargetSources", sources);

...
//        if (StandardCode.getInstance().noNull(lt.getMulti()).equalsIgnoreCase("")&& !lt.getMulti().equalsIgnoreCase("T&E") && !lt.getMulti().equalsIgnoreCase("T&P") && !lt.getMulti().equalsIgnoreCase("E&P")) {
        if (lt.getMulti() != null) {
            isMulti = true;
...
// if(!p.getCompany().isScaleDefault(p.getProjectId())){
            ...
            if (flagT == 0 && flagE == 0 && flagP == 0) {
                formFileName = "PO_Editor" + GeneratePOTemplate.ext + ".pdf";
                tasktype = lt.getTaskName();
            }
// }else{
...
// }
        ...
        /*else if (lt.getMulti().equalsIgnoreCase("T&E")) {
...
//                PdfReader reader = new PdfReader("/Users/abhisheksingh/Project/templates/"+formFileName);
        ...
        if (isMulti) {
                ...
                if (isMinFee) {
                    ...
                    if (!p.getCompany().isScaleDefault(p.getProjectId()) && lt.getWordNew() != null) {
                        ...
                        form1.setField("Rate_new", StandardCode.getInstance().formatDouble4(new Double(rate * scaleNew)));
                        form1.setField("Cost_new", "" + StandardCode.getInstance().formatDouble(wordNewCost * 100 / 100.00));
                        ...
                        form1.setField("Rate_new", StandardCode.getInstance().formatDouble4(new Double(rate * scaleNew4)));
                        form1.setField("Cost_new", "" + StandardCode.getInstance().formatDouble(wordNewCost * 100 / 100.00));
                    }
...
//            }
        ...
        projectReq.addAll(CommService.getInstance().getRequirement("P", "L", p.getCompany().getClientId(), Integer.parseInt(projectId)));
        String reqGenStr = "";
        String reqClientStr = "";

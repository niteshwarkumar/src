...
public final class ProjectViewOverviewAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        Double clientSatisfaction = p.getClientSatisfaction();
        ...
        pvo.set("archiveId", p.getArchiveId());
        if (p.getProductDescription() != null) {
            pvo.set("description", p.getProductDescription());
        } else {
            pvo.set("description", " ");
        }
      //  pvo.set("typeOfText",)
        ...
        try {
             if (clientSatisfaction == 100.0) {
            request.setAttribute("clientSatisfaction100", "checked");
        } else {
            request.setAttribute("clientSatisfaction100", "");
        }
        if (clientSatisfaction == 95.0) {

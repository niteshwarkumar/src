...
public final class ProjectAdd5Action extends Action {
        ...
        for(int i = 0; i < targetLanguage.length; i++) {
            ...
            if(lin1.equals("on")) { //if checked in form, then add this task to target Doc
                ...
                lt.setOrderNum(new Integer(1));
                 unit=HrService.getInstance().getDefaultValue("linguistic");
                if(unit!=null) {
                    lt.setUnits(unit);
                    lt.setUnitsFee(unit);
                }
            ...
            if(lin3.equals("on")) { //if checked in form, then add this task to target Doc
                ...
                unit=HrService.getInstance().getDefaultValue("translation");
                if(unit!=null) {
                    lt.setUnits(unit);
                    lt.setUnitsFee(unit);
                }
            ...
            if(lin4.equals("on")) { //if checked in form, then add this task to target Doc
                ...
                unit=HrService.getInstance().getDefaultValue("editing");
                if(unit!=null) {
                    lt.setUnits(unit);
                    lt.setUnitsFee(unit);
                }
            ...
            if(lin5.equals("on")) { //if checked in form, then add this task to target Doc
                ...
                unit=HrService.getInstance().getDefaultValue("icr");
                if(unit!=null) {
                    lt.setUnits(unit);
                    lt.setUnitsFee(unit);
                }
            ...
            if(lin7.equals("on")) { //if checked in form, then add this task to target Doc
                ...
                unit=HrService.getInstance().getDefaultValue("proofreading");
                if(unit!=null) {
                    lt.setUnits(unit);
                    lt.setUnitsFee(unit);
                }

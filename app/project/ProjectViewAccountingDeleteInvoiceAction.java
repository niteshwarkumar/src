//ProjectViewAccountingDeleteInvoiceAction.java deletes
//one invoice object for this project
...
public final class ProjectViewAccountingDeleteInvoiceAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        String change1Id = request.getParameter("id");
        ClientInvoice c = ProjectService.getInstance().getSingleClientInvoice(Integer.valueOf(change1Id));
        
        //delete this invoice
        AdminService.getInstance().deleteObject(c);

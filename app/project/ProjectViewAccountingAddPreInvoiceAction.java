//ProjectViewAccountingAddPreInvoiceAction.java prepares the form
//for adding a new incoice object
...
public final class ProjectViewAccountingAddPreInvoiceAction extends Action {
	...
	projectId = request.getParameter("projectViewId");
        ...
        //place new object into this form for editing
        DynaValidatorForm qvg = (DynaValidatorForm) form;
        ClientInvoice c = new ClientInvoice();
        c.setNumber(ProjectService.getInstance().getNewInvoiceNumber(p)); //get next number
        c.setInvoiceRequestDate(new Date()); //get current date
        qvg.set("clientInvoiceNew", c);    

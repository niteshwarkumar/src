//ProjectViewAccountingDeleteAction.java deletes
...
public final class ProjectViewAccountingDeleteAction extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        Change1 c = ProjectService.getInstance().getSingleChange(Integer.valueOf(change1Id));
        
        //delete this quality
        ProjectService.getInstance().deleteChange(c);

//ProjectAddOth1Action.java gets the sources
...
public final class ProjectAddOth1Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
        ...
        if(projectId == null) {            
            projectId = StandardCode.getInstance().getCookie("projectAddId", request.getCookies());
        }       
        ...
        String sourceId = StandardCode.getInstance().getCookie("projectAddSourceDocId", request.getCookies());

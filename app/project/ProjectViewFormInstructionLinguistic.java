 ...
 * @author Niteshwar
 */
public class ProjectViewFormInstructionLinguistic extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        byte[] template = getBytesFromFile(new java.io.File("C:/templates2/Instructions - Linguists.rtf"));

...
public final class Client_QuotesSearchPendingAction extends Action {
...
//String status="approved";
        ...
        if (year.equalsIgnoreCase("all")) {
            temp = QuoteHelper.getClientPendingQuoteListForClient(clientId);
        } else {
            temp = QuoteHelper.getClientPendingQuoteListForClient(clientId, year);
        }
//        List temp = QuoteHelper.getClientPendingQuoteListForClient(clientId);

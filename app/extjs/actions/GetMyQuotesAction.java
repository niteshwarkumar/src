...
public final class GetMyQuotesAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        //System.out.println("getPMPendingQuotes entered:");
        
        
//look for pm or ae that matches active projects for this user
        String myName = u.getFirstName() + " " + u.getLastName();
//        List pmQuotes = QuoteHelper.getPMPendingQuotes(myName);
        List pmQuotes = QuoteService.getInstance().getPMPendingQuotes(myName);
        Quote1 q = null;
        ...
        //System.out.println("getPMPendingQuotes took:"+ ((endProjects-startProjects)/1000.0));

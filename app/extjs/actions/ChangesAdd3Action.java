...
public final class ChangesAdd3Action extends Action {
	...
	ActionMessages errors = new ActionMessages();
     ...
     /*   String[] targetLanguage = (String[]) (qae5.get("targetLanguageRight"));  
        ...
        if(linOther.equalsIgnoreCase("on")){}else{
        ...
        String dtp7 = noNull(request.getParameter("dtp7"));
               if(dtpOther.equalsIgnoreCase("on")){}else{
        ...
        String eng8 = noNull(request.getParameter("eng8"));
               if(engOther.equalsIgnoreCase("on")){}else{
       ...
       if(sd.getChangeNo().intValue()==maxChangeNo){     
        ...
        if(lin1.equals("on")) { //if checked in form, then add this task to target Doc
                ...
                lt.setChangeDesc("C"+maxChangeNo);linTasks.add(lt);
          ...
          //Add DTP tasks now
                   ...
                   dt.setChangeDesc("C"+maxChangeNo); dtpTasks.add(dt);
                }
            ...
            for(Iterator iter = dtpTasks.iterator(); iter.hasNext();) {
                ...
                Integer z = ProjectService.getInstance().linkTargetDocDtpTask(td, dt); 
                    ...
                    et.setChangeDesc("C"+maxChangeNo); engTasks.add(et);
                }

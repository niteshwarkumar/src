...
//relationship between quote and file (quote file)
    ...
    String resourceViewId = request.getParameter("resourceViewId");
     request.setAttribute("resourceViewId", resourceViewId);
     ...
     request.setAttribute("oId", oId);
                if(null != docId){
                    Upload_Doc doc = UserService.getInstance().getDocList(Integer.parseInt(docId));
                    QuoteService.getInstance().deleteUploadFile(doc);
                }

...
public final class ProjectAdd1Action extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if(request.getParameter("projectViewId")==null || "".equals(request.getParameter("projectViewId"))){
            ...
            p = ProjectService.getInstance().getSingleProject(Integer.valueOf(request.getParameter("projectViewId")));
            
        }
        
        p.setStatus("active");
        p.setPmPercent("10.00");
        p.setPmPercentDollarTotal("0.00");
        p.setRushPercent("0.00");
        p.setRushPercentDollarTotal("0.00");

...
public final class Client_ViewProjectHistoryOnholdAction extends Action {
...
Calendar cal = new GregorianCalendar();
        ...
        if (year.equalsIgnoreCase("all")) {
            temp = ProjectHelper.getProjectListForClientOnHold(clientId);
        } else {
            temp = ProjectHelper.getProjectListForClientOnHold(clientId, year);
        }

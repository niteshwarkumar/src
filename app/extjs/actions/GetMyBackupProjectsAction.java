...
public final class GetMyBackupProjectsAction extends Action {
...
//look for pm or ae that matches active projects for this user
        ...
        List pmProjects = ProjectHelper.getProjectListForBackupPM(myName);
        Project p = null;
        
        for(ListIterator iter = pmProjects.listIterator(); iter.hasNext();) {
                p = (Project) iter.next();
                JSONObject jo = ProjectHelper.ProjectToJson(p);
                myProjects.add(jo);          
            }
